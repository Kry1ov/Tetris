...
namespace GameSpace
{
	...
	J_Block::J_Block(std::default_random_engine& dre, int positionX, int positionY)
	...
	L_Block::L_Block(std::default_random_engine& dre, int positionX, int positionY)
		:Primitive({ { false, true, false },
						{ false, true, false },
						{ false, true, true } },
			dre, positionX, positionY)
	...
	T_Block::T_Block(std::default_random_engine& dre, int positionX, int positionY)
	...
	O_Block::O_Block(std::default_random_engine& dre, int positionX, int positionY)
	...
	S_Block::S_Block(std::default_random_engine& dre, int positionX, int positionY)
	...
	Z_Block::Z_Block(std::default_random_engine& dre, int positionX, int positionY)
		:Primitive({ { true, true, false },
						{ false, true, true },
						{ false, false, false } },
			dre, positionX, positionY)
	...
	I_Block::I_Block(std::default_random_engine& dre, int positionX, int positionY)
		:Primitive({ { true, true, true },
						{ false, false, false },
						{ false, false, false } },
	...
	Primitive* getPrimitive(std::default_random_engine& dre, int positionX, int positionY)
	{
		...
		{
		case 0:
			return new J_Block(dre, positionX, positionY);
		case 1:
			return new L_Block(dre, positionX, positionY);
		case 2:
			return new T_Block(dre, positionX, positionY);
		case 3:
			return new O_Block(dre, positionX, positionY);
		case 4:
			return new S_Block(dre, positionX, positionY);
		case 5:
			return new Z_Block(dre, positionX, positionY);
		case 6:
			return new I_Block(dre, positionX, positionY);
		default:
			return nullptr;
		}
	}
